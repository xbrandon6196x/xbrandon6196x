...
| 002 | SEO + accesibilidad | Meta description, Open Graph/Twitter cards, favicon declarado, `alt` descriptivos en todas las imágenes, aria-labels en controles (hamburger, player), contraste verificado. El rework remoto de 2026-07 cubrió la base; la feature cerró contraste AA, banner OG y aria-labels bilingües. | Bajo | Hecha |
| 003 | Rendimiento | Optimizar imágenes pesadas (fotos_collage.png, PNGs de iconos → tamaños correctos/WebP), `loading="lazy"` bajo el fold, `font-display`. Sin bundlers: se optimizan los assets mismos. Resultado: 6.5 MB → 426 KB de imágenes referenciadas. | Medio | Hecha |
